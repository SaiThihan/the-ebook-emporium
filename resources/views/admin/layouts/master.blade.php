                ...
                <ul class="nav user-menu">
                    ...
                    <li class="nav-item dropdown has-arrow main-drop">
                        ...
                        <span class="user-img me-2">
                            ...
                            @else
                                <img src="{{ asset('storage/' . Auth::user()->image) }}" alt="profile image" class="rounded">
                            @endif
                            <span class="status online"></span>

                        </span>
                        <div class="text-muted fs-5">{{ Auth::user()->name }}<i class="fa-solid fa-caret-down ms-2"></i></div>
                        </a>
