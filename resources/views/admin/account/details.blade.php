...
<section style="background-color: #eee;">
    <div class="container py-5" style="height: 90vh">
        ...
        <div class="btn btn-primary mb-5 ms-1" onclick="history.back()"><i class="fa-solid fa-arrow-left me-2"></i>Back</div>
      <div class="row">
        <div class="col">
          ...
          <div class="card mb-4">
            <div class="card-body text-center">
              {{-- <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp" alt="avatar"
                class="rounded-circle img-fluid mt-2 img-thumbnail" style="width: 170px;"> --}}
              ...
              <div class="d-flex justify-content-center mb-2 mt-4">
                <button type="button" class="btn btn-primary"><i class="fa-solid fa-user-pen me-2"></i>Edit</button>
