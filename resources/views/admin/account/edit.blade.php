                        ...
                        <form action="{{ route('admin#updateUserDetails') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 col-12">
                                    ...
                                    <div class="form-group">
                                        <label>Gender</label>
                                        <select class="select form-control text-muted @error('gender') is-invalid @enderror" name="gender">
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
                                    ...
                                    <div class="form-group">
                                        <label>Role</label>
                                        <select class="select form-control text-muted @error('role') is-invalid @enderror" disabled>
